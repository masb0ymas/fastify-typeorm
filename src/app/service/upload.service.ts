...
import { yupOptions } from '../middleware/yupValidation'
...
export default class UploadService {
  ...
  public static async create(formData: UploadAttributes): Promise<Upload> {
    ...
    const data = await uploadRepo.save({ ...newEntity, ...formData })
  ...
  public static async update(
    ...
    const newData = await uploadRepo.save({ ...data, ...formData })
